  ...
  return (
    <div className="flex flex-col md:flex-row px-5 py-8 gap-4 md:gap-0">
        <div className="flex items-center">
            <div className="text-clairt-400 bg-mine-shaft-900 rounded-full p-1 mr-2"><IconUserCircle size={20} /></div>
            <Input className="[&_input]:!placeholder:text-mine-shaft-300"  variant="unstyled" placeholder="Search by name" />
        </div>
